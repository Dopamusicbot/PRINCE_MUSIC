...
async def play(_, message: Message):
    ...
    try:
        ...
        await lel.edit(
            f"<i>{user.first_name} was banned in this group, ask admin to unban PrincePersonal manually.</i>"
        )
        return     
    ...
    for i in message.command[1:]:
        query += ' ' + str(i)
    print(query)
    await lel.edit("🎥 __**Generating Thumbnail**__")
